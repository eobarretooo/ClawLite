...
- That WebSocket chunk coalescing is now tunable under `gateway.websocket` (`coalesce_enabled`, `coalesce_min_chars`, `coalesce_max_chars`) while keeping the previous defaults.
