...
- 🤖 `Automation` — cron, inbound journal replay, dead-letter replay, operator channel recovery, Telegram transport refresh, pairing approval/rejection, and offset advance, provider recovery/suppression, candidate cooldowns, supervisor signals, and self-evolution state
