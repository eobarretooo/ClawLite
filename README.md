...
- **Working now**
  ...
  - Telegram reliability test coverage now includes deterministic soak/recovery-style validation for repeated reconnect and outbound transient retry cycles.
