...
- Full suite: `python -m pytest tests/ -q --tb=short` → **1839 passed, 1 skipped**
...
```bash
python -m pytest tests/ -q --tb=short  # 1839 passed, 1 skipped
