...
- Full suite: `python -m pytest tests/ -q --tb=short` → **1802 passed, 1 skipped**
...
```bash
python -m pytest tests/ -q --tb=short  # 1802 passed, 1 skipped
