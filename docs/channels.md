...
- The direct voice helper now also fails closed if Discord's attachment reservation response omits `upload_filename`, instead of attempting the final voice-message POST with an empty uploaded filename.
