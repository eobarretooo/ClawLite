...
- Inbound Discord component interactions now distinguish buttons from string/user/role/channel/mentionable selects and preserve selected values in the emitted event metadata.
