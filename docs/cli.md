...
| `tools approval-audit` | Lists recent live approval-review and grant-revoke audit rows from the gateway | `clawlite tools approval-audit --action review --request-id req-1 --tool browser --rule browser:evaluate` |
