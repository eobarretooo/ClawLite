...
| `tools approval-audit` | Lists recent live approval-review and grant-revoke audit rows from the gateway | `clawlite tools approval-audit --action review --tool browser --rule browser:evaluate` |
